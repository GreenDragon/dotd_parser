def build_proc_name_map():
    ...
    # armaments_dict[""] = { 'name':"Acidskin Charm", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Ascendant Stones", 'slot':'Armament::Relic'}
    ...
    # armaments_dict[""] = { 'name':"Balance", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Ceremonial Veil-Dagger", 'slot':'Armament::Relic'}
    armaments_dict["Fervor"] = { 'name':"Cermarina's Blade", 'slot':'Armament::Relic'}
    armaments_dict["Demigod (Chalice)"] = { 'name':"Chalice of the Eternal Dawn", 'slot':'Armament::Relic'}
    # armaments_dict[""] = { 'name':"Charms of the Devoted", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Comfort", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Dragon Hunter's Guide", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Fey Rituals", 'slot':'Armament::Support'}
    ...
    armaments_dict["Griffin's Bite"] = { 'name':"Griffin's Bite", 'slot':'Armament::Siege'}
    ...
    # armaments_dict[""] = { 'name':"History of the Eternal Dawn", 'slot':'Armament::Support'}
    armaments_dict["Swarm"] = { 'name':"Hive Mind Hex", 'slot':'Armament::Support'}
    armaments_dict["Red Krunan Needs Cheer Badly!"] = { 'name':"Holiday Cheer", 'slot':'Armament::Support'}
    ...
    armaments_dict["Cannonfire Melody"] = { 'name':"Hymn Cannon of the Eternal Dawn", 'slot':'Armament::Siege'}
    # armaments_dict[""] = { 'name':"Incantations", 'slot':'Armament::Support'}
    armaments_dict["Red Harvest"] = {'name':"Infantry Plow", 'slot':'Armament::Siege'}
    ...
    # armaments_dict[""] = { 'name':"King's Blessing", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Knight's Code: Volume I", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Lots of Practice", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Lucian's Guide to Monsters", 'slot':'Armament::Support'}
    ...
    # armaments_dict[""] = { 'name':"Nihilism", 'slot':'Armament::Support'}
    armaments_dict["Word is Bond"] = {'name':"Oath", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Orb of Eventualities", 'slot':'Armament::Support'}
    armaments_dict["Terrible Presence"] = { 'name':"Overwhelming Aura", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Pilfered Goods", 'slot':'Armament::Support'}
    ...
    armaments_dict["On The Road Again"] = {'name':"Portable Lab", 'slot':'Armament::Siege'}
    armaments_dict["Doorway"] = { 'name':"Portal Key", 'slot':'Armament::Relic'}
    armaments_dict["Taste the Rainbow"] = { 'name':"Rainbow Cannon", 'slot':'Armament::Siege'}
    #armaments_dict[""] = { 'name':"Ramis' Retriever", 'slot':'Armament::Relic'}
    armaments_dict["Veil Rip"] = { 'name':"Riftbeast", 'slot':'Armament::Siege'}
    ...
    # armaments_dict[""] = { 'name':"Scepter of Rassys", 'slot':'Armament::Relic'}
    ...
    armaments_dict["Waiting For The Night"] = {'name':"Solstice Clock", 'slot':'Armament::Relic'}
    armaments_dict["THIRTEENTH!"] = { 'name':"Standard of the 13th", 'slot':'Armament::Relic'}
    armaments_dict["Supply and Demand"] = {'name':"Supply Line", 'slot':'Armament::Siege'}
    ...
    # armaments_dict[""] = { 'name':"The People's Courage", 'slot':'Armament::Support'}
    armaments_dict["Half Shell of a Hero"] = {'name':"The Shell of Solus", 'slot':'Armament::Relic'}
    # armaments_dict[""] = { 'name':"Titan's Downfall", 'slot':'Armament::Support'}
    # armaments_dict[""] = { 'name':"Tome of Recorded Atrocities",'slot':'Armament::Suport'}
    ...
    armaments_dict["Burn After Reading"] = {'name':"Von Eldred's Notebook", 'slot':'Armament::Relic'}
